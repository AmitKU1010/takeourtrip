...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <!-- Model Start -->
                           <div class="form-body">
                              <h6 align="center" class="txt-dark" style="font-size:15px;" ><i class="zmdi zmdi-account mr-10"></i>Vendor Payment</h6>
                              <hr class="light-grey-hr"/>
                            </div>
      <div class="col-lg-12">
          <div class="card">
             <div class="card-body">
              <form action="ajax_submit_owner_payment_slip.php" method="post">
               <!-- row start -->
                         <div class="row">
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i>View Vendor Payment</div>
            <div class="card-body">
              ...
              <table id="example" class="table table-bordered">
                ...
                <tbody>
                    <tr>
                       <?php
                    $sql = "SELECT * FROM owner_payment_slip_new";
