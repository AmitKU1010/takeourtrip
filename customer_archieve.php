...
<br />
  ...
  <?php
  $sql="SELECT customer_payment_slip.id,duty_slip.report_at,duty_slip.booked_by from duty_slip INNER JOIN customer_payment_slip ON duty_slip.dutyslip_slno=customer_payment_slip.duty_slip_no WHERE customer_payment_slip.id='$printid'";
