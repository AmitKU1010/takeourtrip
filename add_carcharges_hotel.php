...
<body>
 ...
 $sql="INSERT INTO `hotelcarcharges`(`vehicle_id`,`vehicle_name`,`charging_type`,`day_charge`,`night_holt_charge`,`km_cover_in_one_litre`,`extra_hour_charges`,`price_per_km`,`detaintion_charges`) VALUES ('$vehicle_id','$vehicle_name','$charging_type','$day_charge','$night_holt_charge','$km_cover_in_one_litre','$extra_hour_charges','$price_per_km','$detaintion_charges')";
...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <!-- Model Start -->
                           <div class="form-body">
                              <h6 align="center" class="txt-dark" style="font-size:15px;" ><i class="zmdi zmdi-account mr-10"></i>Add Car Charges(Hotel)</h6>
            ...
            <div class="card-body">
              ...
              <table id="example" class="table table-bordered">
                ...
                <tbody>
                    ...
                    $sql = "SELECT * FROM  hotelcarcharges";
