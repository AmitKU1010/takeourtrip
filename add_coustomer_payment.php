...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <!-- Model Start -->
                           <div class="form-body">
                              <h6 align="center" class="txt-dark" style="font-size:15px;" ><i class="zmdi zmdi-account mr-10"></i>Add Walk-in Payment</h6>
                              <hr class="light-grey-hr"/>
                            </div>
      <div class="col-lg-12">
          <div class="card">
             <div class="card-body">
              <form action="ajax_submit_customer_payment_slip.php" method="post">
               <!-- row start -->
                         <div class="row">
                                ...
                                <div class="col-md-4">
                                  <div class="form-group ">
                                    <label class="control-label mb-10">customer Gst no</label>
                ...
                <div class="col-md-4" id="extra_hour_div">
                                ...
                                <div class="col-md-4" id="detaintiondiv">
                                  <div class="form-group ">
                                    <label class="control-label mb-10">Detaintion Hour</label>
                                  <input type="text" name="detaintion" id="detaintion" class="form-control" placeholder="Detaintion">
                                    <span class="help-block">  </span>
                                  </div>
                                </div>
                                <div class="col-md-4" id="detaintion_charges_div">
                                  <div class="form-group ">
                                  ...
                                  <input type="text" name="detaintion_charges" id="detaintion_charges" class="form-control" placeholder="Detaintion Charges">
                                    ...
                                    <span class="help-block">  </span>
                                    <input type="hidden" name="detaintion_perhour_charges" id="detaintion_perhour_charges" class="form-control" >
                                  </div>
                                </div>
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i>View Walkin Payment</div>
            <div class="card-body">
              ...
              <table id="example" class="table table-bordered">
                ...
                <tbody>
                    <tr>
                       <?php
                    $sql = "SELECT * FROM customer_payment_slip";
                    ...
                    $i = 1;
                     ...
                     <td>#<?php echo $i;?></td>
                      ...
                      <td class="text-nowrap">
                       ...
                       <a href="customer_archieve.php?printid=<?php echo $v1['id']; ?>" target="_blank"><i class="fa fa-file-text-o" aria-hidden="true">
                       </i>
                     </a>
                      
                    <a href="bill_archieve.php?printid=<?php echo $v1['id']; ?>" target="_blank"><i class="fa fa-file-text-o" aria-hidden="true">
                    </i>
                     </a>

                     <a href="bill_archieve_withoutgst.php?printid=<?php echo $v1['id']; ?>" target="_blank"><i class="fa fa-file-text-o" aria-hidden="true">
                    </i>
                     </a>
...
<script>
  ...
  $(document).on('blur', '#duty_slip_no', function()
                 ...
                 $('#journey_from').val(obj[0].place_from);
                  ...
                  $('#fuel_rate').val(obj[0].fuel_rate);
                    ...
                    if (!$("#charging_type").val().length == 0)
                    {
                      ...
                      ({
                        type:"post",
                        url:"ajax_carcharges_customer_get.php",
                        dataType:"html", // Data type, HTML, json etc.
        ...
        $('#detaintion_perhour_charges').val(obj1[0].detaintion_charges);
                            ...
                            var totalkm=$('#total_km').val();
                             var startdt = new Date($("#start_date").val() + " " + $("#starting_time").val());
                                ...
                                // //parseInt(totalkm)/50;
                                 ...
                                 // changed by me
                                 if(detention_hr>hours)
                                 {
                                  // alert(1);
                                  var detaintion_hours =detention_hr-hours;
                                $('#detaintion').val(detaintion_hours);
                                 }
                                 else
                                 {
                                  // alert(2);
                                ...
                                var detaintion_hour_chage = $('#detaintion_perhour_charges').val();
                                var detaintion_hour_chage1 = parseInt(detaintion_hour_chage);
                                var total_detaintion_charge = detaintion_hour_chage1 * parseInt(detaintion_hours);
                                $('#detaintion_charges').val(total_detaintion_charge);
                ...
                $('#totalnighthalt').change(function(){
                  ...
                  $('#night_halt').val(parseInt(nighthaltvalue)*parseInt(night_halt_no));
                     ...
                     var priceper_km=$('#priceper_km').val();
                           ...
                           var totalhavetopay1 = totalhavetopay - total_detaintion_charge;
                           $('#total_adv').val(advguest_amount);
                           var detaintionch = $('#detaintion_charges').val();
                           //var totalchargespaid =totalchargespaid.toFixed();
                            ...
                            var detaintionparktoolnight = parseInt(tool_charge)+parseInt(parking_charge)+parseInt(nighthalt)+parseInt(detaintionch)
              ...
              var totalhavetopay1 = Math.round(parseFloat(nighthalt)+parseFloat(tool_charge)+parseFloat(driverothercharge)+parseFloat(parking_charge)+parseFloat(detaintionch)+parseFloat(tot_amnt)-parseFloat(advguest_amount));
