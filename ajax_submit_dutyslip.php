...
$sql="INSERT INTO `duty_slip`(`dutyslip_slno`, `duty_of`, `report_at`, `booked_by`, `vehicle_no`, `vehicle_id`, `vehicle_name`, `vehicle_size`, `driver_name`, `place_from`, `place_to`, `start_date`, `starting_km`, `start_time`, `closing_km`, `closing_time`, `closing_date`, `total_km`, `total_time`, `charging_type`, `ac_nonac`, `fuel_rate`, `toll_gate`, `parking_charge`, `driver_f_charge`, `other_charge`, `description`, `advance_paid_client`, `advance_paid_travel`, `vehicle_returns`)
...
window.location ='add_dutyslip.php';
    </script>
    <?php
  }
}
