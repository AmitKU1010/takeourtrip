...
$sqlone="UPDATE customercarcharges SET vehicle_name='$vehicle_name',charging_type='$charging_type',day_charge='$day_charge',night_holt_charge='$night_holt_charge',km_cover_in_one_litre='$km_cover_in_one_litre',
extra_hour_charges='$extra_hour_charges',
price_per_km='$price_per_km',
detaintion_charges='$detaintion_charges'
  WHERE id='$getid'";
...
<?php 
$sql="SELECT * FROM `customercarcharges` WHERE id='$getid'";
                        ...
                        <!-- row start -->
                                <div class="row">
                                  ...
                                  <div class="form-group">
                                    ...
                                    value="<?php echo $fetch['vehicle_name'] ?>" readonly>
                                ...
                                <div class="col-md-6" id="priceper_kmdiv">
                                 ...
                                 <div class="col-md-6" id="detaintion_div">
                                  <div class="form-group " >
                                    ...
                                    value="<?php echo $fetch['detaintion_charges'] ?>">
                                    <span class="help-block">  </span>
                                  </div>
                                </div>
